...
<html class="no-js" lang="en">
  ...
  <link rel="stylesheet" href="css/DataTableResponsive/datatables.responsive.css"/>
    <style>
        .title {
            font-size: larger;
            font-weight: bold;
...
<div class        ="container">
    <div class    ="row">
        <div class="col-xs-12 title">Bootstrap v3.x Responsive Example Using DOM</div>
    </div>
...
<script src="js/DataTableResponsive/datatables.responsive.js"></script>
<script src="js/bootstrap/dom-bootstrap3.js"></script>
